...
<div class="col-md-12 new">
  ...
  <div class="col-md-6">
    ...
    <select name="ma_htkt" class="form-control" required="required">
    ...
    <textarea class="form-control" name="ldkt"></textarea>
  </div>
  <div class="col-md-6">
    <label>Năm khen thưởng</label>
    <input type="text" name="nkt_qtkt" class="form-control">

    <label>Thông tin khác</label>
    <textarea class="form-control" name="ttk_qtkt"></textarea>
  </div>
  <div class="col-md-12">
    <center>
